#!/bin/sh
#CONTAINER_IMAGE_NAME=essentialsofparallelcomputing/chapter3
CONTAINER_IMAGE_NAME=chapter3
CONTAINER_USER=chapter3
...
echo ""
echo "VNC Viewers"
echo "    http://realvnc.com/download/viewer -- Linux, Mac and Windows"
echo "    http://www.tightvnc.com -- Linux, Mac and Windows"
echo "to connect to localhost:$VNC_PORT with password $PASSWORD_RANDOM"
echo "MAC: Command-K in Finder and vnc://localhost:$VNC_PORT or vnc://localhost:$VNC_PORT in the Safari Browser"
echo ""
