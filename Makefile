...
CloverLeaf/CloverLeaf_Serial/clover_leaf:
	cd CloverLeaf/CloverLeaf_Serial && \
	     ...
	     cp InputDecks/clover_bm128_short.in clover.in && valgrind --tool=callgrind -v ./clover_leaf && qcachegrind
...
CloverLeaf/CloverLeaf_OpenMP/clover_leaf:
	cd CloverLeaf/CloverLeaf_OpenMP && \
	     ...
	     cp InputDecks/clover_bm128_short.in clover.in && likwid-perfctr -C 0-4 -g MEM_DP ./clover_leaf && \
